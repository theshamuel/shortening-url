...
public class StatRecordControllerTest {
    ...
    public void testGetStatisticsByShortUrlByPeriod() throws Exception {
        ...
        when(statRecordService.getStatisticsByShortUrlByPeriod("abc",new Date(1526763600000L),new Date(1526849999000L))).thenReturn(expected);
        ...
        verify(statRecordService,times(1)).getStatisticsByShortUrlByPeriod("abc",new Date(1526763600000L),new Date(1526849999000L));
    ...
    public void testGetAllStatisticsByPeriod() throws Exception {
        ...
        when(statRecordService.getAllStatisticsByPeriod(new Date(1526763600000L),new Date(1526849999000L))).thenReturn(expectedList);
        ...
        verify(statRecordService,times(1)).getAllStatisticsByPeriod(new Date(1526763600000L),new Date(1526849999000L));
